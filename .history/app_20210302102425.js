...
/******************************************************************************************************************************/
mongoose.connect(
  'mongodb+srv://admin:admin@mayfielddoc.xd5am.mongodb.net/md1?retryWrites=true&w=majority',
...
server.listen(process.env.PORT, function () {
  console.log('PatientRef Local Server is now Running at Port ' + server.address().port);
});