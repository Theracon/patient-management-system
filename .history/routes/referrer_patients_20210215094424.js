...
router.post("/referrers/:var accessionNumber = req.body.accession_number;/patients", middleware.isUserLoggedIn, middleware.isReferrerAuthorized, function(req, res) {
            ...
            if(!err) {
                if(user) {
                    ...
                    var patient = new Patient({
                        ...
                        hospital_name: hospitalArray[req.body.hospitalIndex].hospitalDetails.name,
                        hospital_address: hospitalArray[req.body.hospitalIndex].hospitalDetails.address,
                        hospital_id: hospitalArray[req.body.hospitalIndex]._id,
                    ...
                    patient.save(function(err, patient) {
                        // Find hospital
                        User.findOne({ typeOfUser: "hospital", _id: hospitalArray[req.body.hospitalIndex]._id }, function(err, hospital) {
                            if(hospital) {
