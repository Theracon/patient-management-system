        ...
        if(!err) {
            if(user) {
                ...
                var welcomeMessage = {
                    ...
                    content: "Hi " + user.referrerDetails.title + user.referrerDetails.firstname + ", we're pleased to have you on PatientRef. Feel free to use the FAQs section if you need clarification or reach us by phone or email.",
                    status: "unread"
                }
