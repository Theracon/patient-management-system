            ...
            if(!err) {
                if(user) {
                    ...
                    var welcomeMessage = {
                        ...
                        content: "Hi, " + user.hospitalDetails.name + ", we're pleased to have you on fastclinic. Feel free to use the FAQs section if you need clarifications or reach us by phone or email.",
                        status: "unread"
                    }
