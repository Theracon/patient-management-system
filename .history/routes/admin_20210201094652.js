...
router.get("/admin/:username/livechat", middleware.isAdminLoggedIn, middleware.isAdminAuthorized, function(req, res) {
    User.findOne({ typeOfUser: "admin", username: req.params.username }, function);
